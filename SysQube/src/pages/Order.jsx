    ...
    <div className="max-w-4xl mx-auto bg-white p-8 shadow-lg rounded-lg mt-10">
      ...
      <div className="flex justify-center  mt-6">
        <CustomButton
          type="button"
          title="Place Order"
          containerStyles="text-lg font-semibold flex items-center justify-center w-1/2 text-ascent-1 px-4 md:px-6 py-2 md:py-3 border border-[#666] rounded-sm hover:bg-rblack hover:text-white hover:rounded-sm transition duration-300"
