...
const PaymentForm = () => {
  ...
  const onSubmit = (data) => {
    console.log(data);
    dispatch(getPaymentData(data)); // Dispatch payment data to Redux
    navigate("/order"); // Redirect to review order page
  };
  ...
  return (
    <div className="max-w-2xl mx-auto bg-div p-6 shadow-lg rounded-lg mt-10">
